...
4. Have [Solana Explorer](https://explorer.solana.com/?cluster=devnet) open in another tab
5. `.env` has `ANCHOR_PROGRAM_ID=2qP9GpKCspihqmSggbmu5gg5q5TdDiSGT2JcUhBjUC4G`
